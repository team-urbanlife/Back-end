...
include::{snippets}/schedule/create/request-headers.adoc[]
...
include::{snippets}/schedule/find/request-headers.adoc[]
...
include::{snippets}/schedule/delete/request-headers.adoc[]
